...
public class BlockPlanksAcaciaVertical extends Block {
	
	public BlockPlanksAcaciaVertical() {
		...
		this.setRegistryName("planks_acacia_vertical");
		this.setResistance(15.0F); //Взрывоустойчивость как у камня
		this.setUnlocalizedName("extendedblocks.planks_acacia_vertical");
